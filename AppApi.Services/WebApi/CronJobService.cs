...
namespace AppApi.Services.WebApi
{
    ...
    public static class ScheduledServiceExtensions
    {
        ...
        //         // Không cần đăng ký IScheduleConfig<T> vì bạn truyền config cho constructor của CronJobService trong AddHostedService

        //         services.AddSingleton<IHostedService>(serviceProvider =>
        //         {
        //             return (T)Activator.CreateInstance(typeof(T), config.CronExpression, config.TimeZoneInfo);
        //         });
